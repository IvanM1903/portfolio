    ...
    <div className="container-fluid" id="About-sect">
      <div className="row row-container">
        <div className="col-xs-12 col-md-6">
          <p className="content-aboutme col-xs-12">
          ...
          <div className="picture-container col-xs-12">
            <img className="picture-me" src={Me}></img>
          </div>
        </div>
        <div className="col-xs-12 col-md-6 social-aboutme">
          <div className="LI-profile-badge" data-version="v1" data-size="large" data-locale="es_ES" data-type="vertical" data-theme="dark" data-vanity="ivan-m-p"><a className="LI-simple-link" href='https://es.linkedin.com/in/ivan-m-p?trk=profile-badge'></a></div>
        </div>
      </div>
    </div>
  )
